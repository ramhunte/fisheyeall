...
tags$div(style = "margin: 15px 15px 30px; width: 80%",    
         tags$div(
           ...
           p('Historical landings (2015-2019) are reported for Shorebased whiting in Oregon and Washington, 
              however, starting in 2020, there were only two whiting processors in Washington. To maximize the 
              amount of information shown, 2020 shorebased whiting is suppressed on the Oregon and Washington 
              figures, but shown in the "All" figure exclusively.'),
